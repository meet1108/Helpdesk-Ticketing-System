 ...
 * <code>helpdesk.service.service.impl.TicketLocalServiceImpl</code> and
...
public class TicketLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>helpdesk.service.service.impl.TicketLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static int countTicketByDepartment(String department) {
		return getService().countTicketByDepartment(department);
	}

	public static int countTicketByUserID(long userId) {
		return getService().countTicketByUserID(userId);
	}
	...
	public static List<Ticket> findTicketByDepartment(String department) {
		return getService().findTicketByDepartment(department);
	}

	public static List<Ticket> findTicketByUserId(long userId) {
		return getService().findTicketByUserId(userId);
	}
