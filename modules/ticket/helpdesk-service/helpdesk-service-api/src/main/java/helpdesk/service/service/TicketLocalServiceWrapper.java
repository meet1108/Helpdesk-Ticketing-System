...
package helpdesk.service.service;
...
public class TicketLocalServiceWrapper
	...
	public void addTicket(
		long ticketId, long userId, String requester, String email,
		String subject, String description, String department, String category,
		String subcategory, String priority, String imageattached,
		String status, String createDate) {

		_ticketLocalService.addTicket(
			ticketId, userId, requester, email, subject, description,
			department, category, subcategory, priority, imageattached, status,
			createDate);
	}
	 ...
	 */
	@Override
	public helpdesk.service.model.Ticket addTicket(
		helpdesk.service.model.Ticket ticket) {
	...
	public int countTicketByDepartment(String department) {
		return _ticketLocalService.countTicketByDepartment(department);
	}

	@Override
	public int countTicketByUserID(long userId) {
		return _ticketLocalService.countTicketByUserID(userId);
	}
	 ...
	 */
	@Override
	public helpdesk.service.model.Ticket createTicket(long ticketId) {
	 ...
	 */
	@Override
	public helpdesk.service.model.Ticket deleteTicket(long ticketId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public helpdesk.service.model.Ticket deleteTicket(
		helpdesk.service.model.Ticket ticket) {
	...
	@Override
	public helpdesk.service.model.Ticket fetchTicket(long ticketId) {
		return _ticketLocalService.fetchTicket(ticketId);
	}

	@Override
	public java.util.List<helpdesk.service.model.Ticket> findTicketByDepartment(
		String department) {

		return _ticketLocalService.findTicketByDepartment(department);
	}

	@Override
	public java.util.List<helpdesk.service.model.Ticket> findTicketByUserId(
		long userId) {

		return _ticketLocalService.findTicketByUserId(userId);
	}
	 ...
	 */
	@Override
	public helpdesk.service.model.Ticket getTicket(long ticketId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<helpdesk.service.model.Ticket> getTickets(
		int start, int end) {
	 ...
	 */
	@Override
	public helpdesk.service.model.Ticket updateTicket(
		helpdesk.service.model.Ticket ticket) {
