...
public abstract class BaseUserResourceImpl implements UserResource {
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/user-rest/v1.0/add-user' -d $'{"email": ___, "firstName": ___, "lastName": ___, "password1": ___, "password2": ___, "role": ___, "screenName": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
