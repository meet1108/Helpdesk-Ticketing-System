package com.helpdesk.rest.client.resource.v1_0;
...
import com.helpdesk.rest.client.problem.Problem;
...
public interface UserResource {
	...
	public HttpInvoker.HttpResponse addUserHttpResponse(NewUser newUser)
		throws Exception;
	...
	public static class UserResourceImpl implements UserResource {
		...
		public UserObject addUser(NewUser newUser) throws Exception {
			HttpInvoker.HttpResponse httpResponse = addUserHttpResponse(
				newUser);
			...
			try {
				return com.helpdesk.rest.client.serdes.v1_0.UserObjectSerDes.
					toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
		...
		public HttpInvoker.HttpResponse addUserHttpResponse(NewUser newUser)
			...
			httpInvoker.body(newUser.toString(), "application/json");
