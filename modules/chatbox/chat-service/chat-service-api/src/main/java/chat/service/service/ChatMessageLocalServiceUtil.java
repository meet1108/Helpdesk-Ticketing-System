 ...
 * <code>chat.service.service.impl.ChatMessageLocalServiceImpl</code> and
...
public class ChatMessageLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>chat.service.service.impl.ChatMessageLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static void addChatMessage(
		...
		getService().addChatMessage(ticketId, userId, message, imageAttached);
	}
	 ...
	 */
	public static ChatMessage createChatMessage(long messageId) {
		return getService().createChatMessage(messageId);
	}
	 ...
	 */
	public static ChatMessage deleteChatMessage(long messageId)
		throws PortalException {

		return getService().deleteChatMessage(messageId);
	}
	...
	public static ChatMessage fetchChatMessage(long messageId) {
		return getService().fetchChatMessage(messageId);
	}
	 ...
	 * @throws PortalException if a chat message with the primary key could not be found
	 */
	public static ChatMessage getChatMessage(long messageId)
		throws PortalException {

		return getService().getChatMessage(messageId);
	}
	...
	public static List<ChatMessage> getMessageByTicketId(long ticketId) {
		return getService().getMessageByTicketId(ticketId);
	}
