...
public interface ChatMessageLocalService
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ChatMessage deleteChatMessage(long messageId) throws PortalException;
